...
def build_relationship_sentence(
    ...
    result = get_relationship_narrative(
        ...
        reference_name=get_metric_meta(lang, "metric.level_spending", level=t(f"level.{level}.long", lang)),
        comparison_name=get_metric_meta(lang, cfg["metric_key"], level=t(f"level.{level}.long", lang)),
